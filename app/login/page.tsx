    ...
    <SiteLayout>
      <div className="min-h-screen bg-[#F5F1EC] flex items-center justify-center">
        <div className="w-full max-w-md rounded-2xl border border-[#E6D6C5] bg-white p-8 shadow-sm">
          <h1 className="font-playfair text-3xl text-[#1F3F5B]">Login</h1>
          <p className="mt-2 text-sm text-[#8A8A8A]">Sign in with your admin account.</p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-md border border-[#E6D6C5] px-3 py-2 outline-none"
              />
            </div>
            ...
            <div className="flex items-center justify-end">
              <button
                type="submit"
                disabled={loading}
                className="rounded-full bg-[#1F3F5B] px-5 py-2 text-sm font-semibold text-white disabled:opacity-60"
              >
